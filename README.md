...
16. **Retraso en la detección de nuevos objetos:** Inicialmente, el video se extraía a solo 10 cuadros por segundo para ahorrar carga computacional de análisis. Esto generaba saltos espaciales muy bruscos en los movimientos rápidos, impidiendo que la IA detectara a tiempo a los robots que recién entraban a los bordes de la pantalla.
    * **Solución:** Se ajustaron los parámetros del codificador FFmpeg para aumentar la extracción y compresión a 25 FPS. Al tener más muestras y cuadros intermedios, las transiciones se suavizaron, permitiendo a la IA reaccionar y anclar el rastreo mucho más rápido.
